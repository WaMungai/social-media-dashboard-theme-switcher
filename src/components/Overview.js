...
function Overview() {
  return (
    <>
    <h2 className='max-w-7xl mx-auto text-slate-600  dark:text-white font-bold mb-5 text-2xl md:text-3xl'>Overview - Today</h2>
    <section className='max-w-7xl mx-auto grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4'>
        <article className='bg-slate-200 dark:bg-slate-800 p-5 rounded shadow shadow-slate-50 dark:shadow-slate-700'>
            ...
            <ul className='flex items-center justify-between'>
                <li className='flex items-center text-emerald-600 font-bold text-sm'>87</li>
